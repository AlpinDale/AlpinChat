...
// Dark theme colors - matte black theme
...
val UserBubbleColor = Color(0xFF2B2B2B)  // Dark grey for light theme
val UserBubbleColorDark = Color(0xFF2B2B2B)  // Dark grey for dark theme (OLED)
val AssistantBubbleColor = Color(0xFFE8EAF0)
val AssistantBubbleColorDark = Color(0xFF2D3139)
